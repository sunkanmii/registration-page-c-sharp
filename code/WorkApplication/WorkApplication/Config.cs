...
namespace WorkApplication
{
    public class Config
    {
        ...
        public string server = "remotemysql.com";// MySQL host / ip of the computer
        public string user = "EYcECbJVRr";// MySQL user
        public string password = "OorlkO9QkF";// MySQL password 
        DataSet ds;
        DataTable dt;
